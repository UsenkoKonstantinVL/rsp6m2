...
namespace indikator_rsp_6m2
{
    public partial class Voltmetr : UserControl
    {
        ...
        {
            get { return  Value ; }
            set { Value = value; Invalidate(); OnValueChanged(new SomeEventArgs(Value)); }
        }
        ...
        public void Voltmetr_Paint(object sender, PaintEventArgs e)
        {
            ...
            label2.Text = Center_str;
            label2.Font = drawFont_Type;
            label2.Left = Width / 2 - label2.Width / 2 + 1;
            label2.Top = Height / 2 - label2.Height / 2;
        ...
        private void Voltmetr_Load_1(object sender, EventArgs e)
        {
