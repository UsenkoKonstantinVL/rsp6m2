...
namespace indikator_rsp_6m2
{
    public partial class ikoPasControl : UserControl
    {
        ...
        void DrawExp(Graphics G)
        {
            ...
            {
                G.DrawLine(new Pen(Color.GreenYellow), Convert.ToInt32(GainX1 * (x - 1) + X1sm), Y1sm - Convert.ToInt32(GainY1 * Math.Log(x - 1)), Convert.ToInt32(GainX1 * (x) +X1sm), Y1sm - Convert.ToInt32(GainY1 * Math.Log(x)));
